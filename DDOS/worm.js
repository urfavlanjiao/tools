 ...
 if (process.argv.length < 7){console.log(`node worm.js target time rate thread proxy.txt`); process.exit();}
 const headers = {};
...
headers["Cross-Origin-Embedder-Policy"] = 'Cross-Origin-Embedder-Policy';
headers["Cross-Origin-Opener-Policy"] = 'Cross-Origin-Opener-Policy';
headers["accept"] = 'accept';
headers["accept-language"] = 'accept-language';
headers["Referrer-Policy"] = 'Referrer-Policy';
headers["x-cache"] = 'x-cache';
...
headers["sec-ch-ua-platform"] = 'sec-ch-ua-platform';
headers["upgrade-insecure-requests"] = "1";
headers["sec-fetch-dest"] = 'sec-fetch-dest';
headers["sec-fetch-mode"] = 'sec-fetch-mode';
headers["sec-fetch-site"] = 'sec-fetch-site';
headers["X-Forwarded-Proto"] = HTTPS;
headers["sec-ch-ua"] = 'sec-ch-ua';
headers["sec-ch-ua-mobile"] = 'sec-ch-ua-mobile'
headers["sec-ch-ua-platform"] = 'sec-ch-ua-platform'
headers["vary"] = 'vary';
